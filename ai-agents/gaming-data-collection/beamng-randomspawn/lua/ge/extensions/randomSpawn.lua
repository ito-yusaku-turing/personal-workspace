...
local levelSpawns = {
  west_coast_usa = {  -- West Coast USA／チャイナタウン地区の 5 地点
    { p = { -584.7,  413.6, 109.5  }, rE = {  -3.6,  -4.1, -64.6 } },
    { p = { -902.4, -399.0, 101.5  }, rE = {  -2.3, -10.4, -26.0 } },
    { p = { -711.6, -837.1, 128.3  }, rE = {  -2.0,   7.2, 166.0 } },
    { p = {  336.8, -117.7, 144.67 }, rE = {   0.0,   0.0, -64.0 } },
    { p = { -636.0, 2023.3,  79.0  }, rE = { -13.2, -13.5, -63.6 } },
  },
}
